    ...
    <div class="container">
      <div class="grid gap-10 md:grid-cols-3 mb-6">
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li>
              <NuxtLink class="hover:text-highlight" to="/about">{{ t('nav.about') }}</NuxtLink>
            </li>
            <li>
              <NuxtLink class="hover:text-highlight" to="/submission">{{ t('nav.submit') }}</NuxtLink>
            </li>
            <li>
              <NuxtLink class="hover:text-highlight" to="/judges">{{ t('nav.judges') }}</NuxtLink>
            </li>
            <li>
              <NuxtLink class="hover:text-highlight" to="/timeline">{{ t('nav.timeline') }}</NuxtLink>
            </li>
          </ul>
        </div>
        <div>
